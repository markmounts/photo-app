In the app/views/devise/registrations folder, open the new.html.erb file and add the code below to the section right under the closing div, below the password confirmation:
```ruby
